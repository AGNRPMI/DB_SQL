...
DROP TABLE IF EXISTS {itresume9521845.schema_name}.mobile_phones;
-- создаём таблицу с мобильными телефонами (mobile_phones)
CREATE TABLE {itresume9521845.schema_name}.mobile_phones (
...
-- наполнение данными
INSERT INTO {itresume9521845.schema_name}.mobile_phones (product_name, manufacturer, product_count, price)
VALUES
