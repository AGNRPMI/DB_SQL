...
ALTER TABLE itresume9521845.mobile_phones
ADD COLUMN manufacturer_id BIGINT,
ADD CONSTRAINT fk_manufacturer
    FOREIGN KEY (manufacturer_id)
    REFERENCES itresume9521845.manufacturer(id)
    ON UPDATE CASCADE ON DELETE SET NULL;

-- Обновление значения manufacturer_id в таблице mobile_phones на основе поля manufacturer
UPDATE itresume9521845.mobile_phones SET manufacturer_id = 1 WHERE manufacturer = 'Apple';
UPDATE itresume9521845.mobile_phones SET manufacturer_id = 2 WHERE manufacturer = 'Samsung';
UPDATE itresume9521845.mobile_phones SET manufacturer_id = 3 WHERE manufacturer = 'Huawei';
...
SELECT id, product_name, manufacturer_id FROM itresume9521845.mobile_phones;